        ...
        <form style="background-color:transparent" enctype="multipart/form-data" id="submitPlanForm" v-on:submit="submitPlan">
            ...
            <fieldset class="form-group" name="PlanStatus">
             ...
             <div class="form-group row">
                ...
                <div class="col-5">
                     <input  type="date" name="PlanTimeS" class="form-control-file" id="startDate" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                     <input  type="date" name="PlanTimeE" class="form-control-file" id="endDate" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                     <input  type="file" name="File" class="form-control-file" id="extraFile" required>
                </div>
...
export default {
  ...
  methods: {
    submitPlan: function(event) {
      ...
      Const.request(Const.ADD_PLAN, new FormData($("#submitPlanForm")[0]).append("UIDstr",Const.getSessionStorage(Const.ACCOUNT_INFO).AccountID),
       function(response) {
